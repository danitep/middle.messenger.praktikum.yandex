...
import {
  PropsWithChildren, Props, Events, Children, Lists,
} from '../utils/blockInterfaces';
...
export default class Block {
  ...
  _componentDidMount() {
    ...
    Object.values(this.children).forEach(() => { this.dispatchComponentDidMount(); });
  }
  ...
  setProps = (newProps:PropsWithChildren) => {
    ...
    if (Object.values(lists).length) { Object.assign(this.lists, lists); }
